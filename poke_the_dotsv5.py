...
class Game:
    ...
    def draw_game_over(self):
        # Draw GAME OVER in lower left corner of the surface
        # use small dot's color for font
        # use big dot's color as background
        string = 'GAME OVER'
...
class Dot:
    ...
    def intersects(self, dot):
        # Return True if two dots intersect and False if they do not
